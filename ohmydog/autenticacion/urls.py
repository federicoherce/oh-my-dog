...
from .views import registro, cerrar_sesion, loguear, mi_perfil, mis_mascotas, modificar_datos_cliente, lista_de_clientes, modificar_datos_perro, generar_pdf_perro
...
urlpatterns = [
    ...
    path('perfil/<str:dni>/modificar/<int:perro_id>', modificar_datos_perro, name="modificar_datos_perro"),
    path('perro/<int:perro_id>/pdf/', generar_pdf_perro, name="generar_pdf_perro")
]
